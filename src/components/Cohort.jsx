        ...
        <div className="card">
          ...
          <div className="overlay">
            ...
            <div className="class-starting-price">
              Starts as low as <span>₹2,990</span>
            </div>
